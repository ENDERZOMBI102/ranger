...
def hook_init(fm: ranger.core.fm.FM) -> None:  # pylint: disable=unused-argument
...
def hook_ready(fm: ranger.core.fm.FM) -> None:  # pylint: disable=unused-argument
...
def register_linemode[T: type[LinemodeBase]](linemode_class: T) -> T:
