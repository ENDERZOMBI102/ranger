...
import ranger.container.history
import ranger.core.shared


class Tab(ranger.core.shared.FileManagerAware, ranger.core.shared.SettingsAware):  # pylint: disable=too-many-instance-attributes

    def __init__(self, path):
        self.thisdir = None  # Current Working Directory
        self._thisfile = None  # Current File
        self.history = ranger.container.history.History(self.settings.max_history_size, unique=False)
        ...
        self.fm.signal_bind('move', self._set_thisfile_from_signal, priority=ranger.container.settings.SIGNAL_PRIORITY_AFTER_SYNC, weak=True )
