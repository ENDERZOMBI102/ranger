...
class Actions( ranger.core.shared.FileManagerAware, ranger.core.shared.SettingsAware, abc.ABC ):  # pylint: disable=too-many-instance-attributes,too-many-public-methods
    """
    A mixin class to add actions to the file manager
    """
    mode: str
    loader: typing.Any
    commands: typing.Any
    ...
    def get_tab_list(self):
        ...
        class NaturalOrder:  # pylint: disable=too-few-public-methods
